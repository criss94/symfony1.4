...
abstract class BasesfGuardGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'categorias_list'  => new sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'Categorias')),
    ));
  ...
  public function addCategoriasListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.RolesCategoria RolesCategoria')
      ->andWhereIn('RolesCategoria.rol_cat_id', $values)
    ;
  }
