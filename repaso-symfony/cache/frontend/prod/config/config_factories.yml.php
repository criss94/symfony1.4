...
// date: 2017/10/23 16:05:46
  ...
  'cache_dir' => '/var/www/repaso-symfony/cache/frontend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/repaso-symfony/apps/frontend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/repaso-symfony/cache/frontend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/repaso-symfony/apps/frontend/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'cristianveizaga11@gmail.com',
      'password' => 'developernodejs123',
    ),
  ),
))));
