   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('.boton_favorito').click(function(){
          if($(".boton_favorito").is(':checked')) {  
              //alert("Está activado");  
              var boton_id = $(this).val();
              var user_id = $('.user_id').val();
              //alert('el id del boton es: ' + boton_id);
              //alert('el id de usuario es: ' + user_id);

              //$('#form_agregar_favoritos').submit();
