...
abstract class BaseServiceGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%ser_icono%% - %%ser_link%% - %%ser_nombre%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'ser_icono',  2 => 'ser_link',  3 => 'ser_nombre',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'ser_link' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'URL',  'attributes' =>   array(    'class' => 'form-control',  ),),
