...
abstract class autoNewsActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->noticias = $this->form->getObject();
  }
  ...
  {
    $this->noticias = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->noticias);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Noticias'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $noticias)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@noticias_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'noticias_edit', 'sf_subject' => $noticias));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('Noticias');
  ...
  {
    return Doctrine_Core::getTable('Noticias')->hasColumn($column);
  }
}
