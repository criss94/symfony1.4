 ...
 * @property DATETIME $not_inicio_pub
 * @property DATETIME $not_fin_pub
 * 
 ...
 * @method DATETIME getNotInicioPub()   Returns the current record's "not_inicio_pub" value
 * @method DATETIME getNotFinPub()      Returns the current record's "not_fin_pub" value
...
abstract class BaseNoticias extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('not_inicio_pub', 'DATETIME', null, array(
             'type' => 'DATETIME',
             'notnull' => true,
             ));
        $this->hasColumn('not_fin_pub', 'DATETIME', null, array(
             'type' => 'DATETIME',
             'notnull' => true,
             ));
    }
