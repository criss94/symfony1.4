 ...
 * @property Doctrine_Collection $rol_group_id
 * 
 ...
 * @method Doctrine_Collection getRolGroupId()             Returns the current record's "rol_group_id" collection
 ...
 * @method sfGuardGroup        setCategorias()             Sets the current record's "Categorias" collection
 ...
 * @method sfGuardGroup        setRolGroupId()             Sets the current record's "rol_group_id" collection
 * 
...
abstract class BasesfGuardGroup extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('RolesCategorias as rol_group_id', array(
             'local' => 'id',
