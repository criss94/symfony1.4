...
abstract class autoCategoryActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->categorias = $this->form->getObject();
  }
  ...
  {
    $this->categorias = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->categorias);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Categorias'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $categorias)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@categorias_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'categorias_edit', 'sf_subject' => $categorias));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('Categorias');
  ...
  {
    return Doctrine_Core::getTable('Categorias')->hasColumn($column);
  }
}
