...
<?php slot('title') ?>
    Edición de <?php echo $servicios->getSerNombre() ?>
<?php end_slot() ?>
...
<div id="sf_admin_container">
  ...
  <div class="container paddingtop30 paddingbottom30">
    <h1 class="text-center"><?php echo __('Edicion de %%ser_nombre%%', array('%%ser_nombre%%' => $servicios->getSerNombre()), 'messages') ?></h1>
      ...
      <div class="col-xs-12 col-sm-6 col-md-4 col-center marginbottom20">
        <div class="alert alert-info">
          <div class="panel-body text-center">
            <strong>AVISO</strong>
            <p class="font11 gray clearmargin">Ingresa tu clase CSS (solo la clase) para crear tu icono, de donde? hace click <a href="http://fontawesome.io/icons/"> aquí</a> buscalo, copialo y pegalo!</p>
